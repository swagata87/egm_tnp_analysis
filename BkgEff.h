...
// Mon Sep  2 14:58:18 2019 by ROOT version 6.18/00
// from TTree fitter_tree/fitter_tree
// found on file: /eos/cms/store/group/phys_egamma/swmukher/Run3_DYtoEE/JamboreeAug19/ttbar_semilep_2018.root
//////////////////////////////////////////////////////////
...
#ifdef BkgEff_cxx
BkgEff::BkgEff(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_egamma/swmukher/Run3_DYtoEE/JamboreeAug19/ttbar_semilep_2018.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/group/phys_egamma/swmukher/Run3_DYtoEE/JamboreeAug19/ttbar_semilep_2018.root");
      }
      std::cout << f << std::endl;
      TDirectory * dir = (TDirectory*)f->Get("/eos/cms/store/group/phys_egamma/swmukher/Run3_DYtoEE/JamboreeAug19/ttbar_semilep_2018.root:/tnpEleIDs");
...
Int_t BkgEff::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BkgEff::LoadTree(Long64_t entry)
{
...
void BkgEff::Show(Long64_t entry)
{
...
Int_t BkgEff::Cut(Long64_t entry)
{
